...
namespace Paylike.NETStandard.Interfaces
{
    public interface ITransactions
    {
        ...
        Task<PaylikeApiResponse<Transaction>> Capture(string transactionId, int amountAsMinor, string currency, string descriptor);
        ...
        Task<PaylikeApiResponse<Transaction>> Void(string transactionId, int amountAsMinor);
    }
}
